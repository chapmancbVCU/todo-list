...
export class NotesForm {
    ...
    initializeComponents() {
        ...
        editorArea.setAttribute('toolbar', 'undo redo | bold italic underline backcolor strikethrough | outdent indent | alignleft aligncenter alignright alignjustify | removeformat | help');
